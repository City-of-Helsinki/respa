    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.IntegerField(verbose_name='Ordering priority')),
        ...
        migrations.AddField(
            model_name='resourceaccessibility',
            name='viewpoint',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='accessibility_summaries', to='resources.AccessibilityViewpoint', verbose_name='Resource Accessibility'),
        ),
