    ...
    def post(self, request):
        ...
        if data_rows[0][0] == '2':
            ...
            for row in data_rows:
                ...
                for resource_type in resource_types:
                    if resource_type.main_type == 'berth':
        ...
        if data_rows[0][0] == '3':
            ...
            for i, row in enumerate(data_rows):
                ...
                BerthReservation.objects.get_or_create(reservation=reservation, berth=berth, state_updated_at=state_updated_at, is_paid_at=is_paid_at, is_paid=is_paid)
                resource.save()
